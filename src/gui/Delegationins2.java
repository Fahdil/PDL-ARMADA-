...
public class Delegationins2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delegationins2 frame = new Delegationins2();
