...
public class MeeeeessageValidationInscrip {
	...
	private static Message prepareMessage(Session session, String envoyeurDemail, String recepient) {
		try {
			 ...
			 message.setText(" Apres etude de votre incription, cette derniere n'a pas ete valider \n Veillez vous reinscrit soit Contactez directement les organisateur \n vous pouvez donc vous connectez \n Merci pour votre confiance \n cordialement, \n LES ORGANISATEURS \n\n\n\n contactamarda@gmail.org");
			 return message;
		} catch(Exception ex) {
		   Logger.getLogger(MeeeeessageValidationInscrip.class.getName()).log(Level.SEVERE, null, ex);	
		}
		return null;
	}
